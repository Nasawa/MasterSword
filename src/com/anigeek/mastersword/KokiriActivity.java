...
public class KokiriActivity extends BaseActivity //implements AdListener
{	
    ...
    public void onCreate(Bundle savedInstanceState)// Basically main
	{
        ...
        setContentView(R.layout.kokiri);// gets the .xml used to make the layout
        zelda = (ImageView)findViewById(R.id.kokiri);
        back = "KA";
        startup();
